          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <p className="text-xs text-slate-400 leading-relaxed font-medium">
                Enter your Last.fm username or profile URL below. We will automatically fetch your avatar and streaming history. <br /><span className="text-white font-bold tracking-widest uppercase mt-1 block">No password required.</span>
              </p>
            </div>
