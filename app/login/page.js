  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background-dark text-slate-100 font-sans">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-accent-magenta/10 rounded-full blur-[120px] pointer-events-none animate-pulse-slow"></div>
      ...
      <div className="w-full max-w-lg relative z-10 mx-auto">
        <div className="glass-card rounded-[2.5rem] p-8 sm:p-12 shadow-[0_0_50px_rgba(124,58,237,0.15)] border border-white/10 relative overflow-hidden">

          {/* Top accent line */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-accent-cyan via-primary to-accent-magenta"></div>

          <div className="text-center mb-10">
            <Link href="/" className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 border border-primary/30 mb-6 group hover:bg-primary/20 transition-all hover:scale-105">
              <span className="material-symbols-outlined text-4xl text-primary group-hover:text-white transition-colors">login</span>
            </Link>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="flex-shrink-0 mx-4 text-xs font-black text-slate-500 uppercase tracking-widest">OR USE</span>
                <div className="flex-grow border-t border-white/10"></div>
              </div>
              ...
              <button
                ...
                className="w-full bg-white text-background-dark hover:bg-slate-200 py-4 rounded-xl font-black uppercase tracking-wider text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mt-4"
              >
                {loading ? (
                  <>
            ...
            <div className="pt-8 mt-8 border-t border-white/10 flex flex-col items-center gap-4 text-sm">
              <p className="text-slate-400">
                New to ARMYBATTLES?{' '}
                <Link href="/signup" className="text-accent-cyan font-bold hover:text-white transition-colors">
                  Sign Up
                </Link>
              </p>
